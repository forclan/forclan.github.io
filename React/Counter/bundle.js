...
/***/ function(module, exports, __webpack_require__) {
	...
	var finalCreateStore = (0, _redux.applyMiddleware)(_middleWare2.default)(_redux.createStore);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function counterOperation() {
	  ...
	  switch (action.type) {
	    case _actions.INCREASE:
	      return { counter: state.counter + 1 };
	    case _actions.DECREASE:
	      return { counter: state.counter - 1 };
	    case _actions.CLEAR_COUNTER:
	      return { counter: 0 };
	    default:
	      return state;
	  }
	...
	exports.default = counterOperation;
...
/***/ function(module, exports) {
	...
	exports.counterDecrease = counterDecrease;
	exports.counterClear = counterClear;
	exports.counterAsyncAdd = counterAsyncAdd;
	// 导出的事件类型
	var INCREASE = exports.INCREASE = 'INCREASE';
	var DECREASE = exports.DECREASE = 'DECREASE';
	var CLEAR_COUNTER = exports.CLEAR_COUNTER = 'CLEAR_COUNTER';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Counter = function (_Component) {
	  ...
	  _createClass(Counter, [{
	    ...
	    value: function render() {
	      ...
	      var counterDecrease = _props.counterDecrease;
	      var counterClear = _props.counterClear;
	      var counterAsyncAdd = _props.counterAsyncAdd;
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onClick: counterClear },
	            'Clear'
	          ),
	          _react2.default.createElement(
	            'button',
	            { onClick: counterAsyncAdd },
	            'AsyncAdd'
	          )
	        )
	      );
	...
	Counter.PropTypes = {
	  ...
	  counterDecrease: _react.PropTypes.func.isRequired,
	  counterClear: _react.PropTypes.func.isRequired,
	  counterAsyncAdd: _react.PropTypes.func.isRequired
	};
